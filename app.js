...
const copy = {
  es: {
    ...
    confirmInfo:'Confirmo que la información suministrada es correcta.', back:'Atrás', continue:'Continuar', sendWhatsApp:'Enviar cuestionario por WhatsApp', sentTitle:'Cuestionario enviado', sentInstruction:'Ahora abra Confirmafy y seleccione la fecha disponible que prefiera.', newRequest:'Nueva solicitud', returnModalTitle:'¡Importante!', returnModalText:'Luego de enviar el cuestionario por WhatsApp, regrese nuevamente a esta página para seleccionar la fecha de su cita.', returnModalRule:'Debe completar este proceso en el orden indicado. Si no sigue todos los pasos, su solicitud quedará incompleta y no podremos confirmar ni brindar el servicio.', continueWhatsApp:'Entendido, continuar a WhatsApp', cancel:'Volver',
    ...
    policyMustRead:'Debe leer la política completa antes de enviar.',
    ...
    waTitle:'SOLICITUD DE SERVICIO - OASIS',
  ...
  en: {
    ...
    policyMustRead:'You must read the complete policy before sending.',
